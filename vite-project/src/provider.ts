...
//     console.log('doSend', method, params, targetChain, waitForConnection)
...
//           console.log('got message2', event)
...
//   try {
//     console.log('got request for provider')
...
import icon from './injected.svg';
// import { LBProvider } from './content/provider';
import { announceProvider } from 'mipd';
import { LBProvider } from './zeproivda';
