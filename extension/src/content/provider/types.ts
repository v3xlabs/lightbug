...
import { EthereumProvider } from "../../content";
...
export declare namespace IProviderEvents {
  ...
  interface EventArguments {
    ...
    session_event: any; // SignClientTypes.EventArguments["session_event"];
    session_update: any; // SignClientTypes.EventArguments["session_delete"];
    display_uri: string;
  }
}
